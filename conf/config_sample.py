...
POOL_TARGET = 0.005                # Pool-wide difficulty target int >= 1
...
DIFF_UPDATE_FREQUENCY = 60   # How often to check coindaemon difficulty. Should be less than coin difficulty retarget time
VDIFF_MIN_TARGET = 0.001           # Minimum target difficulty
VDIFF_MAX_TARGET = 10         # Maximum target difficulty
...
VDIFF_RETARGET_TIME = 30       # How often the miners difficulty changes if appropriate
